...
class ELMoEmbedding(Layer):
    ...
    def __init__(self, idx2word, output_mode="default",
                 trainable=True, **kwargs):
        assert output_mode in ["default", "word_emb",
                               "lstm_outputs1", "lstm_outputs2", "elmo"]
    ...
    def call(self, x):
        ...
        return self.elmo_model(
            inputs, signature="tokens", as_dict=True)[self.output_mode]
